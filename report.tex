...
Another way of running the toolchain for every single input file is to run './run\textunderscore on\textunderscore all\textunderscore inputs.sh'
...
Here are some renderings of various objects.
