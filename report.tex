...
The project could be improved by using different types of input files. Instead of raw input, a flag to the program with an \emph{xml}, \emph{json}, or \emph{toml} file could be specified. These configurations are easier to read and write.
