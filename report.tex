...
Using values larger than $0.1$ sometimes gave NaN values, depending on the Reynolds number. An upper limit is reached aroung $0.5$. I decided to keep it at $0.01$ to give the algorithm some flexibility. Higher values can cause NaN to pop up (especially with tight boundary conditions).
